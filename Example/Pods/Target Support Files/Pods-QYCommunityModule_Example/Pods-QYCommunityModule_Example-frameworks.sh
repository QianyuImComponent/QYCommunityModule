...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QYCommunityModule/QYCommunityModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QYUtilCore/QYUtilCore.framework"
